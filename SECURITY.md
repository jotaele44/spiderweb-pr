...
- Preferred: open a private [GitHub Security Advisory](https://github.com/jotaele44/spiderweb-pr/security/advisories/new)
  for this repository.
...
This policy covers the `spiderweb-pr` source code and its CI/CD configuration.
