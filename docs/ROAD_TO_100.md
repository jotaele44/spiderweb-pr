...
- Content-bound checkpoint/resume and tracked-file data-policy lint are on `main`
  (`63b8c4b`); typed errors, geo-anchors v2 and licensing/SPDX remain
  implementation gaps.
...
2. Implement geo-anchors v2 and then adjudicate dependent pixel-CV work.
3. Reconcile GUI parity against current main and reduce or explicitly classify legacy gaps.
4. Certify standalone packaging for the merged isolated-clone runtime.
