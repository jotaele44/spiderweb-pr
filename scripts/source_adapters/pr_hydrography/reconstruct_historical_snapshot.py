...
def reconstruct(root: Path, output: Path) -> dict:
    ...
    document = {
        "schema": "spiderweb.pr_hydrography.historical_snapshot_set.v0_1",
        "snapshot_set_id": "PR_HYDROGRAPHY_2026_08_11",
        "as_of": "2026-08-11",
        ...
        "state": "PASS_2026_08_11_SNAPSHOT_SET_RECONSTRUCTED",
    }
...
def main() -> int:
    ...
    parser.add_argument("--output", default="manifests/pr_hydrography/runtime/historical_snapshot_set_2026_08_11.json")
