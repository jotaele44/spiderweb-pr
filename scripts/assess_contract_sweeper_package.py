#!/usr/bin/env python3
"""Run the production readiness gate for a Contract-Sweeper export package."""
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--package", required=True, help="Contract-Sweeper export package directory")
...
def main(argv: list[str] | None = None) -> int:
    ...
    report = assess_contract_sweeper_package(args.package, args.out)
