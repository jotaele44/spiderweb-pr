...
# GEBCO's documented vertical reference (gebco.net, "Gridded Bathymetry Data"):
# "GEBCO's global elevation models are generated by the assimilation of
# heterogeneous data types assuming all of them to be referred to mean sea
# level." GEBCO itself notes some shallow-water source data may carry other
# vertical datums that haven't been fully reconciled. This is *not* a single
# named geodetic datum (no EGM epoch, no tidal datum) — treat it accordingly
# for anything beyond general bathymetric visualization.
GEBCO_VERTICAL_REFERENCE = "mean_sea_level_assumed"
