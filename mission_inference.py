...
MISSION_PROFILES: Dict[MissionType, MissionProfile] = {
    ...
    MissionType.MEDICAL_TRANSPORT: MissionProfile(
        mission_type=MissionType.MEDICAL_TRANSPORT,
        typical_altitude_min=500, typical_altitude_max=3000,
        typical_speed_min=80, typical_speed_max=160,
        typical_duration_min=10, typical_duration_max=120,
        infrastructure_types=["hospital", "landing_pad", "trauma_center"],
        operating_hours="24/7",
        typical_operators=["AeroMed PR", "Air Methods", "PR Dept of Health"],
        typical_altitude_variance=0.3, typical_terrain="urban",
        hover_behavior=0.8, repetitive_route=0.2, linear_corridor=0.3, search_pattern=0.1,
    ),
    MissionType.TRAINING: MissionProfile(
        mission_type=MissionType.TRAINING,
        typical_altitude_min=1000, typical_altitude_max=5000,
        typical_speed_min=60, typical_speed_max=120,
        typical_duration_min=30, typical_duration_max=180,
        infrastructure_types=["airport", "airfield"],
        operating_hours="07:00-22:00",
        typical_operators=["FAA FSDO", "Private", "Flight School"],
        typical_altitude_variance=0.5, typical_terrain="varied",
        hover_behavior=0.2, repetitive_route=0.7, linear_corridor=0.4, search_pattern=0.3,
    ),
    MissionType.UTILITY_WORK: MissionProfile(
        mission_type=MissionType.UTILITY_WORK,
        typical_altitude_min=200, typical_altitude_max=1500,
        typical_speed_min=20, typical_speed_max=80,
        typical_duration_min=60, typical_duration_max=480,
        infrastructure_types=["transmission_line", "pipeline", "power_substation"],
        operating_hours="06:00-18:00",
        typical_operators=["PREPA", "Puerto Rico Aqueduct", "Contractor"],
        typical_altitude_variance=0.4, typical_terrain="varied",
        hover_behavior=0.5, repetitive_route=0.8, linear_corridor=0.9, search_pattern=0.1,
    ),
    MissionType.ANTI_SMUGGLING: MissionProfile(
        mission_type=MissionType.ANTI_SMUGGLING,
        typical_altitude_min=200, typical_altitude_max=5000,
        typical_speed_min=80, typical_speed_max=180,
        typical_duration_min=120, typical_duration_max=600,
        infrastructure_types=["port", "maritime_chokepoint", "radar_installation"],
        operating_hours="Night preferred",
        typical_operators=["CBP AMO", "USCG", "DEA"],
        typical_altitude_variance=0.7, typical_terrain="coastal",
        hover_behavior=0.3, repetitive_route=0.4, linear_corridor=0.5, search_pattern=0.6,
    ),
}
